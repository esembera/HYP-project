  ...
  <div class="md:container md:mx-auto">
    ...
    >
      ...
      >
        ...
        <div class="detailsButton" v-if="project.id == hoveredProject">
          Details
        </div>
      </div>
    </div>
    <div id="linkContainers">
      <div class="w-11/12 text-left md:mb-20 mt-10 md:mt-0 mb-10">
        <NuxtLink to="/projects" @click="activeMenuItem = 'projects'">
          <span class="md:text-3xl open-sans text-xl"
            ...
            <span class="font-bold">All projects</span></span
          >
        </NuxtLink>
      </div>
      <div class="w-11/12 text-right md:mb-20 mt-10 md:mt-0 mb-10">
        <NuxtLink to="/projects/by_area" @click="activeMenuItem = 'projects'">
          <span class="md:text-3xl open-sans text-xl"
            >next <span class="font-bold">Projects by area</span>&nbsp;<SvgArrow
              class="inline mb-1"
          /></span>
        </NuxtLink>
      </div>
