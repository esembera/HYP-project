...
<template>
    <div class="md:container md:mx-auto">
        ...
        <div id="buttonContainer">
            <NuxtLink class="nextLink" to="/contact" @click="activeMenuItem = 'contact'">
        ...
        <div class="w-11/12 text-right md:mb-20 mt-10 md:mt-0 mb-10">
            <NuxtLink to="/projects/most_relevant" @click="activeMenuItem = 'projects'">
                <span class="md:text-3xl open-sans text-xl">next <span class="font-bold">Most Relevant</span>&nbsp;
                    <SvgArrow class="inline mb-1" />
                </span>
            </NuxtLink>
        </div>
        <ProjectDetails v-show="showModal" @close-modal="showModal = false;" :project="childParameter"
            :projects="projects" />
    </div>
</template>
